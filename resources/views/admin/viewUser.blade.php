              ...
              <table id="datatable1" class="table display responsive nowrap">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><span style="    background: red;color: white;padding: 8px;border-radius: 10px;">Pending</span></td>
                  </tr>
                  <tr>
                    <td>Garrett</td>
                    <td>Winters</td>
                    ...
                    <td><span style="    background: green;color: white;padding: 8px;border-radius: 10px;">Approve</span></td>
