                        ...
                        <div class="col-12">
                            <div class="col-lg-10 col-xl-10 col-md-10 col-12" style="margin: auto;">
                                ...
                                <div class="card text-center"
                                    style="    border-radius: 5px;box-shadow: rgb(100 100 111 / 20%) 0px 7px 29px 0px;">
                                    ...
                                    <div class="card-body" style="    padding: 36px;">
                                            ...
                                            <div class="col-12" style="    text-align: start;font-size: 15px;">
                                                ...
                                                <div class="form-group" style="text-align: center;">
                                                    ...
                                                    @if (Auth::user()->statuss == 'Unverified')
                                                        ...
                                                        <a href="{{ Auth::user()->apiUrl }}" target="blank"
                                        ...
                                        <a href="{{ url('admin/generate-pdf', Auth::user()->id) }}" class="btn btn-info ">
                                            Download Document </a>
